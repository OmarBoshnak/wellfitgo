...
const MessageBubble = React.memo(function MessageBubble({ message, showAvatar, avatarUri }: Props) {
    ...
    return (
        <View style={[styles.container, isMe ? styles.containerMe : styles.containerClient]}>
            ...
            <View style={[styles.bubbleWrapper, isMe ? styles.bubbleWrapperMe : styles.bubbleWrapperClient]}>
                ...
                <View style={[styles.metaRow, isMe ? styles.metaRowMe : styles.metaRowClient]}>
...
const styles = StyleSheet.create({
    ...
    avatarContainer: {
        ...
        marginLeft: horizontalScale(8), // RTL spacing
    },
    avatar: {
        width: horizontalScale(28),
    ...
    bubbleMe: {
        borderBottomLeftRadius: horizontalScale(4), // RTL: tail on left
        shadowColor: '#000',
